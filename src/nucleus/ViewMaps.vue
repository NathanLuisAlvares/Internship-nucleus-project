<template>
  ...
  style="display:grid; grid-template-columns: auto auto auto; padding: 10px; height: 20vh;">
    <div class="m-auto">
      <h6>Your Position</h6>
...
const GOOGLE_MAPS_API_KEY = 'AIzaSyDmPaCUIzbIJwIA7hucsIMpo9qVDtieT-k'
export default {
  name: 'App',
  setup() {
